...
(function() {
  $(function() {
    var append_picture, channel, checkLoginInfo, createGallery, fail, generate_html_elm, infiniteScrolling, insert_pictures, onFail, prepend_picture, pusher, removeGalleryIfPresent, remove_clicked_color, showMorePictures, takePicture, uploadPictureFromLibrary, upload_picture, win;
    ...
    window.deviceReady = function() {
      return checkLoginInfo(function(act_code) {
        var url;
